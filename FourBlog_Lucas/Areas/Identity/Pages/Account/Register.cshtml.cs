...
namespace FourBlog_Lucas.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Compare("Password", ErrorMessage = "As senhas inseridas precisam ser iguais.")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.Nome = Input.Nome; //Colocado por mim
                user.DataNascimento = (DateTime)Input.DataNascimento; //Colocado por mim
